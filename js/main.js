...
const jobBaseData = {
    ...
    "Farmer": {name: "Farmer", maxXp: 100, income: 20},
    "Fisherman": {name: "Fisherman", maxXp: 200, income: 30},
    "Miner": {name: "Miner", maxXp: 400, income: 80},
    "Blacksmith": {name: "Blacksmith", maxXp: 800, income: 160},
    "Merchant": {name: "Merchant", maxXp: 1600, income: 300},

    "Squire": {name: "Squire", maxXp: 100, income: 10},
    "Footman": {name: "Footman", maxXp: 1000, income: 100},
    "Veteran footman": {name: "Veteran footman", maxXp: 10000, income: 200},
    "Knight": {name: "Knight", maxXp: 100000, income: 600},
    "Veteran knight": {name: "Veteran knight", maxXp: 1000000, income: 2000},
    "Elite knight": {name: "Elite knight", maxXp: 7500000, income: 6000},
    "Holy knight": {name: "Holy knight", maxXp: 40000000, income: 30000},
    "Legendary knight": {name: "Legendary knight", maxXp: 150000000, income: 100000},
    ...
    "Wizard": {name: "Wizard", maxXp: 100000000, income: 100000},
    ...
    "Illustrious Chairman": {name: "Illustrious Chairman", maxXp: 7000000000000, income: 3000000},

    "Junior Caretaker": {name: "Junior Caretaker", maxXp: 100000, income: 30},
    "Lead Caretaker": {name: "Lead Caretaker", maxXp: 1000000, income: 250}, 
    "Freshman": {name: "Freshman", maxXp: 2000000, income: 500}, 
    "Sophomore": {name: "Sophomore", maxXp: 4000000, income: 1000}, 
    "Junior": {name: "Junior", maxXp: 16000000, income: 2000}, 
    "Senior": {name: "Senior", maxXp: 64000000, income: 4000}, 
    "Probation": {name: "Probation", maxXp: 300000000, income: 25000},

    "Baronet": {name: "Baronet", maxXp: 7500000, income: 7000},
    "Baron": {name: "Baron", maxXp: 40000000, income: 9000},
    "Vice Count": {name: "Vice Count", maxXp: 160000000, income: 12000},
    "Count": {name: "Count", maxXp: 640000000, income: 16000},
    "Duke": {name: "Duke", maxXp: 2400000000, income: 50000},
    "Grand Duke": {name: "Grand Duke", maxXp: 9600000000, income: 80000},
    "Arch Duke": {name: "Arch Duke", maxXp: 40000000000, income: 110000},
    "Lord": {name: "Lord", maxXp: 160000000000, income: 300000},
    "High Lord": {name: "High Lord", maxXp: 160000000000000, income: 600000},
    "King": {name: "King", maxXp: 160000000000000, income: 1200000},
    "High King": {name: "High King", maxXp: 160000000000000, income: 2000000},
    "Emperor of Mankind": {name: "Emperor of Mankind", maxXp: 160000000000000, income: 5000000},
...
const itemBaseData = {
    ...
    "Large house": {name: "Large house", expense: 12000, effect: 729},
    "Small Manor": {name: "Small Manor", expense: 150000, effect: 2000},
    "Small palace": {name: "Small palace", expense: 500000, effect: 6000},
    "Grand palace": {name: "Grand palace", expense: 1000000, effect: 20000},
    ...
    "Dumbbells": {name: "Dumbbells", expense: 20, effect: 5, description: "Strength xp"},
    "Personal squire": {name: "Personal squire", expense: 100, effect: 3, description: "Job xp"},
    "Steel longsword": {name: "Steel longsword", expense: 5000, effect: 3, description: "Military xp"},
    "Butler": {name: "Butler", expense: 3700, effect: 3, description: "Happiness"},
    "Sapphire charm": {name: "Sapphire charm", expense: 25000, effect: 9, description: "Magic xp"},
    "Study desk": {name: "Study desk", expense: 50000, effect: 2, description: "Skill xp"},
    "Library": {name: "Library", expense: 600000, effect: 5, description: "Skill xp"},
    ...
    "Small Shop": {name: "Small Shop", expense: 600, effect: 3.0, description: "Merchant upgrade"},
    "Weapon Outlet": {name: "Weapon Outlet", expense: 3000, effect: 9.0, description: "Merchant upgrade"},
}
