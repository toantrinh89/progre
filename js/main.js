...
const jobBaseData = {
    ...
    "Squire": {name: "Squire", maxXp: 100, income: 55},
    "Footman": {name: "Footman", maxXp: 1000, income: 550},
    "Veteran footman": {name: "Veteran footman", maxXp: 10000, income: 520},
    "Knight": {name: "Knight", maxXp: 100000, income: 1500},
    "Veteran knight": {name: "Veteran knight", maxXp: 1000000, income: 5000},
    "Elite knight": {name: "Elite knight", maxXp: 7500000, income: 15000},
    "Holy knight": {name: "Holy knight", maxXp: 40000000, income: 155000},
    "Legendary knight": {name: "Legendary knight", maxXp: 150000000, income: 250000},

    "Student": {name: "Student", maxXp: 100000, income: 500},
    "Apprentice mage": {name: "Apprentice mage", maxXp: 1000000, income: 5000},
    "Mage": {name: "Mage", maxXp: 10000000, income: 37500},
    "Wizard": {name: "Wizard", maxXp: 100000000, income: 250000},
    "Master wizard": {name: "Master wizard", maxXp: 10000000000, income: 1250000},
    "Chairman": {name: "Chairman", maxXp: 1000000000000, income: 5000000},
    "Illustrious Chairman": {name: "Illustrious Chairman", maxXp: 7000000000000, income: 7500000},

    "Junior Caretaker": {name: "Junior Caretaker", maxXp: 100000, income: 75},
    "Lead Caretaker": {name: "Lead Caretaker", maxXp: 1000000, income: 515}, 
    "Freshman": {name: "Freshman", maxXp: 2000000, income: 1250}, 
    "Sophomore": {name: "Sophomore", maxXp: 4000000, income: 2500}, 
    "Junior": {name: "Junior", maxXp: 16000000, income: 5000}, 
    "Senior": {name: "Senior", maxXp: 64000000, income: 12000}, 
    "Probation": {name: "Probation", maxXp: 300000000, income: 62000},

    "Baronet": {name: "Baronet", maxXp: 7500000, income: 13500},
    "Baron": {name: "Baron", maxXp: 40000000, income: 24500},
    "Vice Count": {name: "Vice Count", maxXp: 160000000, income: 36000},
    "Count": {name: "Count", maxXp: 640000000, income: 48000},
    "Duke": {name: "Duke", maxXp: 2400000000, income: 125000},
    "Grand Duke": {name: "Grand Duke", maxXp: 9600000000, income: 240000},
    "Arch Duke": {name: "Arch Duke", maxXp: 40000000000, income: 255000},
    "Lord": {name: "Lord", maxXp: 160000000000, income: 750000},
    "High Lord": {name: "High Lord", maxXp: 160000000000000, income: 1300000},
    "King": {name: "King", maxXp: 160000000000000, income: 1300000},
    "High King": {name: "High King", maxXp: 160000000000000, income: 7200000},
    "Emperor of Mankind": {name: "Emperor of Mankind", maxXp: 160000000000000, income: 7500000},
...
const itemBaseData = {
    ...
    "Steel longsword": {name: "Steel longsword", expense: 1000, effect: 50, description: "Military xp"},
    "Butler": {name: "Butler", expense: 7500, effect: 5, description: "Happiness"},
    "Sapphire charm": {name: "Sapphire charm", expense: 50000, effect: 30, description: "Magic xp"},
    "Study desk": {name: "Study desk", expense: 1000000, effect: 5, description: "Skill xp"},
    "Library": {name: "Library", expense: 12000000, effect: 4, description: "Skill xp"},
    "Small Field": {name: "Small Field", expense: 130, effect: 10.0, description: "Farm upgrade"},
    "Ox-driven Plow": {name: "Ox-driven Plow", expense: 200, effect: 10, description: "Farm upgrade"},
    "Livestock-derived Fertilizer": {name: "Livestock-derived Fertilizer", expense: 20, effect: 5, description: "Farm upgrade"},
    "Cheap Fishing Rod": {name: "Cheap Fishing Rod", expense: 20, effect: 5.0, description: "Fishing upgrade"},
    "Miner's Lantern": {name: "Miner's Lantern", expense: 35, effect: 5, description: "Mining upgrade"},
    "Crappy Anvil": {name: "Crappy Anvil", expense: 50, effect: 5, description: "Blacksmith upgrade"},
    "Breech Bellows": {name: "Breech Bellows", expense: 130, effect: 5, description: "Blacksmith upgrade"},
    "Pack Horse": {name: "Pack Horse", expense: 80, effect: 10.0, description: "Merchant upgrade"},
    "Small Shop": {name: "Small Shop", expense: 600, effect: 10, description: "Merchant upgrade"},
    "Weapon Outlet": {name: "Weapon Outlet", expense: 3000, effect: 15.0, description: "Merchant upgrade"},
}
