...
const jobBaseData = {
    "Beggar": {name: "Beggar", maxXp: 5, income: 10},
    "Farmer": {name: "Farmer", maxXp: 10, income: 20},
    "Fisherman": {name: "Fisherman", maxXp: 20, income: 30},
    "Miner": {name: "Miner", maxXp: 40, income: 80},
    "Blacksmith": {name: "Blacksmith", maxXp: 80, income: 160},
    "Merchant": {name: "Merchant", maxXp: 160, income: 300},

    "Squire": {name: "Squire", maxXp: 10, income: 10},
    "Footman": {name: "Footman", maxXp: 100, income: 100},
    "Veteran footman": {name: "Veteran footman", maxXp: 10000, income: 200},
    "Knight": {name: "Knight", maxXp: 10000, income: 600},
    "Veteran knight": {name: "Veteran knight", maxXp: 100000, income: 2000},
    "Elite knight": {name: "Elite knight", maxXp: 750000, income: 6000},
    "Holy knight": {name: "Holy knight", maxXp: 4000000, income: 30000},
    "Legendary knight": {name: "Legendary knight", maxXp: 15000000, income: 100000},

    "Student": {name: "Student", maxXp: 10000, income: 200},
    "Apprentice mage": {name: "Apprentice mage", maxXp: 100000, income: 2000},
    "Mage": {name: "Mage", maxXp: 1000000, income: 15000},
    "Wizard": {name: "Wizard", maxXp: 10000000, income: 100000},
    "Master wizard": {name: "Master wizard", maxXp: 1000000000, income: 500000},
    "Chairman": {name: "Chairman", maxXp: 100000000000, income: 2000000},
    "Illustrious Chairman": {name: "Illustrious Chairman", maxXp: 700000000000, income: 3000000},

    "Junior Caretaker": {name: "Junior Caretaker", maxXp: 10000, income: 30},
    "Lead Caretaker": {name: "Lead Caretaker", maxXp: 100000, income: 250}, 
    "Freshman": {name: "Freshman", maxXp: 200000, income: 500}, 
    "Sophomore": {name: "Sophomore", maxXp: 400000, income: 1000}, 
    "Junior": {name: "Junior", maxXp: 1600000, income: 2000}, 
    "Senior": {name: "Senior", maxXp: 6400000, income: 4000}, 
    "Probation": {name: "Probation", maxXp: 30000000, income: 25000},

    "Baronet": {name: "Baronet", maxXp: 75000, income: 7000},
    "Baron": {name: "Baron", maxXp: 400000, income: 9000},
    "Vice Count": {name: "Vice Count", maxXp: 1600000, income: 12000},
    "Count": {name: "Count", maxXp: 6400000, income: 16000},
    "Duke": {name: "Duke", maxXp: 24000000, income: 50000},
    "Grand Duke": {name: "Grand Duke", maxXp: 96000000, income: 80000},
    "Arch Duke": {name: "Arch Duke", maxXp: 40000000, income: 110000},
    "Lord": {name: "Lord", maxXp: 160000000, income: 300000},
    "High Lord": {name: "High Lord", maxXp: 16000000000, income: 600000},
    "King": {name: "King", maxXp: 16000000000, income: 1200000},
    "High King": {name: "High King", maxXp: 160000000000, income: 2000000},
    "Emperor of Mankind": {name: "Emperor of Mankind", maxXp: 160000000000, income: 5000000},
...
const itemBaseData = {
    ...
    "Tent": {name: "Tent", expense: 10, effect: 9},
    "Wooden hut": {name: "Wooden hut", expense: 50, effect: 27},
    "Cottage": {name: "Cottage", expense: 375, effect: 81},
    "House": {name: "House", expense: 1500, effect: 243},
    "Large house": {name: "Large house", expense: 1200, effect: 729},
    "Small Manor": {name: "Small Manor", expense: 15000, effect: 2000},
    "Small palace": {name: "Small palace", expense: 50000, effect: 6000},
    "Grand palace": {name: "Grand palace", expense: 100000, effect: 20000},

    //Cameron's first addition: rag clothing. Woohoo!
    "Rag Clothing": {name: "Rag Clothing", expense: 3, effect: 10, description: "Skill xp"},
    "Book": {name: "Book", expense: 10, effect: 10, description: "Skill xp"},
    "Basic Farm Tools": {name: "Basic Farm Tools", expense: 10, effect: 3, description: "Farm upgrade"},
    "Dumbbells": {name: "Dumbbells", expense: 20, effect: 10, description: "Strength xp"},
    "Personal squire": {name: "Personal squire", expense: 100, effect: 10, description: "Job xp"},
    "Steel longsword": {name: "Steel longsword", expense: 5000, effect: 10, description: "Military xp"},
    "Butler": {name: "Butler", expense: 3700, effect: 10, description: "Happiness"},
    "Sapphire charm": {name: "Sapphire charm", expense: 25000, effect: 20, description: "Magic xp"},
    "Study desk": {name: "Study desk", expense: 50000, effect: 10, description: "Skill xp"},
    "Library": {name: "Library", expense: 600000, effect: 10, description: "Skill xp"},
    "Small Field": {name: "Small Field", expense: 60, effect: 5.0, description: "Farm upgrade"},
    ...
    "Pack Horse": {name: "Pack Horse", expense: 80, effect: 10.0, description: "Merchant upgrade"},
    "Small Shop": {name: "Small Shop", expense: 600, effect: 10.0, description: "Merchant upgrade"},
    "Weapon Outlet": {name: "Weapon Outlet", expense: 3000, effect: 10.0, description: "Merchant upgrade"},
}
